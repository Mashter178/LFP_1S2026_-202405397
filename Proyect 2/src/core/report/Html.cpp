...
bool writeHtmlDocument(const std::string& outputPath, const std::string& title, const std::string& bodyHtml) {
    ...
    out << "    th, td { border: 1px solid #a8b3b0; padding: 10px 12px; text-align: left; vertical-align: top; }\n";
    out << "    th { background: #15543a; color: #ffffff; font-weight: 700; }\n";
    out << "    tbody tr:nth-child(even) td { background: #e6ece9; }\n";
    ...
    out << "    .pill.info { background: #dbeafe; color: #1d4ed8; }\n";
    ...
    out << "    td.status-ok { background: #2f855a !important; color: #ffffff; font-weight: 700; text-align: center; }\n";
    out << "    td.status-warn { background: #e67e22 !important; color: #ffffff; font-weight: 700; text-align: center; }\n";
    out << "    td.status-danger { background: #c0392b !important; color: #ffffff; font-weight: 700; text-align: center; }\n";
    out << "    td.status-info { background: #1f618d !important; color: #ffffff; font-weight: 700; text-align: center; }\n";
