...
std::string buildReportsIndexBody() {
    ...
    body << "<tr><td>1</td><td>Historial de Pacientes</td><td><a href=\"historial_pacientes.html\">historial_pacientes.html</a></td></tr>";
    body << "<tr><td>2</td><td>Carga de Medicos por Especialidad</td><td><a href=\"carga_medicos_especialidad.html\">carga_medicos_especialidad.html</a></td></tr>";
    body << "<tr><td>3</td><td>Agenda de Citas con Conflictos</td><td><a href=\"agenda_citas_conflictos.html\">agenda_citas_conflictos.html</a></td></tr>";
    body << "<tr><td>4</td><td>Estadistico General del Hospital</td><td><a href=\"estadistico_general_hospital.html\">estadistico_general_hospital.html</a></td></tr>";
    body << "</tbody></table>";
    body << "</div>";
    return body.str();
}
...
bool Generator::generateAllHtmlReports(
    ...
    ok = writeHospitalStatsHtmlReport((basePath / "estadistico_general_hospital.html").string(), data, semanticValidation) && ok;
